welcome_message = "Ты написал(а) новостному боту🤖\n\n<b>По умолчанию, он будет отправлять " \
                  "курсы валют, погоду из Москвы и одну новость по одной из ключевых тем: " \
                  ...
                  "идеи для развития проекта. Сейчас это очень важно для меня и создателя!</i>\n\n" \
                  "<i>Ты можешь подробнее ознакомиться с этим и другими интересными ботами на канале " \
                  "<b>@botshares</b></i>"
