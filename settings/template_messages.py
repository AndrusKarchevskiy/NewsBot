welcome_message = "Ты написал(а) новостному боту🤖\n\n<b>По умолчанию, он будет отправлять " \
                  ...
                  "<i>Обрати внимание, что бот находится на стадии тестирования, временно может не работать. " \
                  "Пожалуйста, сообщай в группу <b>@andrus_news_group</b> обо всех ошибках, опечатках, предлагай " \
...
information_message = '<b>Способы настройки бота:</b>\n' \
                      ...
                      '✔Чтобы выбрать ключевое слово (фразу), по которому(ой) ты будешь ' \
                      ...
                      'У бота есть чат: <b>@andrus_news_group</b>, в котором ' \
